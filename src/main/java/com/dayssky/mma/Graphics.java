...
public class Graphics {
    public static final Map<String, ResourceLocation> RARITY_TO_TEXTURE = Map.of(
            "artifact", new ResourceLocation("mma:textures/inventory_overlay/artifact.png"),
            "epic", new ResourceLocation("mma:textures/inventory_overlay/epic.png"),
            "legendary", new ResourceLocation("mma:textures/inventory_overlay/legendary.png"),
            "rare", new ResourceLocation("mma:textures/inventory_overlay/rare.png"),
            "unique", new ResourceLocation("mma:textures/inventory_overlay/unique.png")
    );

    public static final List<ResourceLocation> CHARM_RARITY_TO_TEXTURE = List.of(
            new ResourceLocation("mma:textures/inventory_overlay/charm_common.png"),
            new ResourceLocation("mma:textures/inventory_overlay/charm_uncommon.png"),
            new ResourceLocation("mma:textures/inventory_overlay/charm_rare.png"),
            new ResourceLocation("mma:textures/inventory_overlay/charm_epic.png"),
            new ResourceLocation("mma:textures/inventory_overlay/charm_legendary.png")
    );
