...
public class PortalStateTracker implements StateTracker {
    ...
    public void onRender(WorldRenderContext context) {
        if (MMAClient.config().portal.enablePortalButtonIndicator) {
    ...
    public List<Component> getAdditionalSidebarText() {
        ...
        parts.add(Component.translatable("hud.mma.sidebar.portal.chests", new Object[]{FormatUtil.numeric(this.data.chestCount)}));
        parts.add(Component.translatable("hud.mma.sidebar.portal.souls", new Object[]{FormatUtil.numeric(this.data.soulCount)}));
        return parts;
    }
    ...
    public static class Data {
        ...
        public void send() {
            StatsUtil.dumpStats("stat.mma.portal", this);
        }
    }
}
