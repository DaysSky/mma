...
import com.floweytf.fma.util.Access;
...
public class ZenithModule {
   private static final KeyMapping copyStatsBinding = new KeyMapping("key.fma.cz_copy_stats", Type.KEYSYM, 73, "category.fma");
                  ...
                  if (!CLIPBOARD_QUEUE.containsKey(charm.getUuid())) {
                     ...
                     Minecraft.getInstance()
                        ...
                        .addToast(
                           new SystemToast(
                              COPIED_DATA_TOAST,
                              Component.translatable("text.fma.toast.add_charm_data.title"),
                              Component.translatable("text.fma.toast.add_charm_data.message")
                           )
                        );
                  } else {
                     Minecraft.getInstance()
                        ...
                        .addToast(
                           new SystemToast(
                              ...
                              Component.translatable("text.fma.toast.add_charm_data_fail.title"),
                              Component.translatable("text.fma.toast.add_charm_data_fail.message")
                           )
                        );
                  }
               }
               ...
               CommandUtil.lit(
                  ...
                  CommandUtil.lit(
                     ...
                     context -> {
                        ...
                        ChatUtil.send(
                           Component.translatable("text.fma.cz.copied_charm_data")
                              .withStyle(
                                 s -> {
      ...
      getCharm(NBTUtil.access(stack), CharmDataRegistries.getMain())
         .ifPresent(
            charm -> {
               ...
               Zenith config = FMAClient.config().zenith;
               ...
               String currVersionString = FMAClient.MOD.getMetadata().getVersion().getFriendlyString();
                     ...
                     .append(
                        FormatUtil.literal(
                           ...
                           switch (FMAClient.VERSION_CHECK.getVersionInfo().state()) {
                              ...
                              case NOT_AVAILABLE, DISABLED, NOT_READY -> ChatFormatting.GRAY;
