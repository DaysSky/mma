...
public class ContractCheck {
    ...
    public static void onChangeGameMode() {
        ...
        if (mc.player != null && mc.player.experienceLevel >= FMAClient.config().features.contractThreshold && 
    ...
    public static void tick() {
        if (!(mc.player != null && mc.player.experienceLevel <= FMAClient.config().features.czContractThreshold)) return;
        updateXYZ(mc.player);
