      ...
      if (currentTime > this.nextLogTime) {
         ...
         Minecraft.getInstance()
            ...
            .addToast(
               new SystemToast(
                  EXCEPTION_TOAST,
                  Component.translatable("text.fma.toast.uncaught_exception.title"),
                  Component.translatable("text.fma.toast.uncaught_exception.message")
               )
            );

         try {
            ChatUtil.sendWarn(
               Component.translatable("text.fma.toast.uncaught_exception.message_copy_data")
