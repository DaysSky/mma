...
import com.floweytf.fma.FMAConfig.DisplayCharmExamples;
import com.floweytf.fma.FMAConfig.Zenith;
import com.floweytf.fma.FMAConfig.ZenithAbilitySelection;
import com.floweytf.fma.features.cz.CharmLorePeliRenderer;
import com.floweytf.fma.features.cz.CharmLoreRenderer;
import com.floweytf.fma.features.cz.CharmLoreTabularRenderer;
import com.floweytf.fma.features.cz.ZenithModule;
import com.floweytf.fma.features.cz.data.Charm;
...
public class FMAConfigHandlerHelper {
   public static final Gson GSON = new GsonBuilder()
      .registerTypeAdapter(new TypeToken<Set<CharmEffectType>>(){}.getType(), new CharmEffectTypeSer())
      .setPrettyPrinting()
      .disableHtmlEscaping()
      .create();
   ...
   private static class CharmEffectTypeSer implements JsonSerializer<Set<CharmEffectType>>, JsonDeserializer<Set<CharmEffectType>> {
      ...
      public Set<CharmEffectType> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
         Set<String> modifiers = context.deserialize(json, new TypeToken<Set<String>>(){}.getType());
   ...
   public static void register() {
      Map<CharmType, Charm> charmDummies = Map.of(
         CharmType.ABILITY,
         readDummyCharm("/assets/fma/zenith_charm_dummy_ability.snbt"),
         CharmType.TREE,
         readDummyCharm("/assets/fma/zenith_charm_dummy_tree.snbt"),
         CharmType.WILDCARD,
         readDummyCharm("/assets/fma/zenith_charm_dummy_wildcard.snbt")
      );
      AutoConfig.getGuiRegistry(FMAConfig.class)
